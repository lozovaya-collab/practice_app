...
/** Construct a type with the properties of T except for those in type K. */
export type OmitTaskCreateParamsAuthorId =
  PickTaskCreateParamsExcludeKeysAuthorId
...
> extends HttpClient<SecurityDataType> {
  ...
  users = {
    ...
    GetById: (id: string, params: RequestParams = {}) =>
      this.request<
        User | null,
        UserNotAuthorized | InternalServerErrorResponse
      >({
        path: `/users/${id}`,
        method: 'GET',
        secure: true,
    ...
    Delete: (id: string, params: RequestParams = {}) =>
      this.request<
        boolean,
        UserAuthorizationFailed | InternalServerErrorResponse
      >({
        path: `/users/${id}`,
        method: 'DELETE',
        format: 'json',
  ...
  tasks = {
    ...
    Get: (
      ...
      this.request<
        Task[],
        UserNotAuthorized | UserValidateError | InternalServerErrorResponse
      >({
        path: `/tasks`,
        method: 'GET',
        query: query,
    ...
    Create: (data: OmitTaskCreateParamsAuthorId, params: RequestParams = {}) =>
      this.request<
        Task,
        UserNotAuthorized | TaskValidateError | InternalServerErrorResponse
      >({
        path: `/tasks`,
        method: 'POST',
        body: data,
